...
const getRandomProducts = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield components_service_1.componentsService.getRandomProducts();
    res.send({ message: 'success', status: 200, data: result });
}));
const getComponents = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield components_service_1.componentsService.getComponents();
    res.send({ message: 'success', status: 200, data: result });
}));
const getComponentById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    console.log(id);
    const result = yield components_service_1.componentsService.getComponentById(id);
    res.send({ message: 'success', status: 200, data: result });
}));
...
const getComponentByCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { category } = req.params;
    const result = yield components_service_1.componentsService.getComponentByCategory(category);
    res.send({ message: 'success', status: 200, data: result });
}));
